...
had been that mass could not reach the 25 g ceiling and 2.37x thrust was required, but that was
...
load is not avoidable: the payload's own thrust reacts 70 mm above the thrust line (413 N x
...
not to buckle, 2x the flagship track's entire bending stiffness; at 795 kN it is 16x. The
...
|---|---|---|
| SMA (Nitinol) | modulus 28 to 75 GPa, 2.7x | actuation and latching, not EI |
...
| At 10x looser guidance (cable drive, no airgap) | ~33,000 N·m² |
...
|---|---:|---|
| Single BeCu boom, 50 x 0.2 mm | 1,257 N·m² | neither |
| Single CFRP boom, 150 x 0.3 mm | 39,761 N·m² | cable drive only |
...
|---:|---:|---:|---:|---:|
| 2 mm | 2.87 mm | 45 Hz | 7.1, arrives ringing | 4.1x |
| 4 mm | 0.72 mm | 90 Hz | 14.3 | 16.3x |
| 6 mm | 0.32 mm | 136 Hz | 21.4 | 36.6x |
